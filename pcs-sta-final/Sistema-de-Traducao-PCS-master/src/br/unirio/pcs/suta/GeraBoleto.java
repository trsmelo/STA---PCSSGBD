...
public class GeraBoleto {
	...
	public void fazBoleto (String nomeCliente, String cpfCliente, String enderecoCliente, String numeroCliente, String complementoCliente, String bairroCliente, String cepCliente, String cidadeCliente,double totalPedido) {
		...
		titulo.setValor(BigDecimal.valueOf(totalPedido)); // -------->> Ainda precisar ser passado esse valor no método
		titulo.setDataDoDocumento(DDMMYYYY_B.parse(dtf.format(hoje)));
		titulo.setDataDoVencimento(DDMMYYYY_B.parse("31/12/2018"));
